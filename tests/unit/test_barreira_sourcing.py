...
def test_tabelas_unificadas_so_pelo_nucleo():
    ...
    tabelas = r"\b(processo|contrato|documento|requisito|evento|evento_contrato|participante|item|proposta|proposta_item|avaliacao|esclarecimento|anexo)_sourcing\b"
    violacoes = []
...
def test_cada_lado_so_usa_o_proprio_lado_com_o_nucleo():
    ...
    donos = {"COMPRA": (APP / "contexts" / "procurement", APP / "api" / "v1" / "procurement.py", APP / "api" / "v1" / "strategic_sourcing.py", APP / "api" / "v1" / "portal_fornecedor.py"),
...
def test_repositorio_de_compra_so_no_lado_comprador():
    permitidos = (APP / "contexts" / "procurement", APP / "api" / "v1" / "procurement.py", APP / "api" / "v1" / "strategic_sourcing.py", APP / "api" / "v1" / "portal_fornecedor.py")
