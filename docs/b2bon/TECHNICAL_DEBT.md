...
| TD-090 | Sinais de risco do comprador consultam a pesquisa de preços uma vez por processo aberto (`precos.resumo` dentro do laço) | `procurement/riscos.py:79` | N+1: 40 processos → 49 consultas em `/procurement/riscos` e 58 no workspace (baseline da Phase A) | Phase D | OPEN |
