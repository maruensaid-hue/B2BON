...
| TD-087 | Até a S6 toda escrita de sourcing grava duas vezes (tabela antiga + espelho) e as leituras dos repositórios conferem as tabelas novas (COMPARAR) | `bids/espelho.py`, `procurement/espelho.py`, repositórios | Custo extra de escrita/leitura durante a migração; some na S6 | S6 | OPEN (temporária, por desenho) |
