...
export function ProcessoWorkspace() {
  ...
  return (
    <div className="flex flex-col gap-3.5" data-testid="processo-workspace">
      <Link to="/compras" className="text-[11px] text-cyan">
        ← Compras públicas
      </Link>
      <div>
        <div className="font-head text-xl font-bold">{ws.overview.objeto}</div>
        <div className="text-[11px] text-muted">
          {ws.overview.numero ?? "sem número"} · status {ws.overview.status}
        </div>
      </div>
