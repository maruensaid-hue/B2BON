...
__all__ = [
    "cadastros", "contratos", "demandas", "documentos", "estrategico", "estrategico_ia", "estrategico_sinais", "fluxo", "fornecedores", "metricas", "nba", "planejamento", "portal", "precos", "repositorio", "riscos", "tipos",
    "workspace",
]
