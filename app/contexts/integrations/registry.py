...
from app.contexts.integrations.adapters import hubspot, pipedrive, salesforce
...
_VALIDADORES: dict[str, ValidadorConexao] = {"salesforce": salesforce.validar, "hubspot": hubspot.validar, "pipedrive": pipedrive.validar}
